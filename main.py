...
def execFideliusCli(args):
    ...
    print(os.environ)
    jdk_res1 = subprocess.call(["sudo", "add-apt-repository", "ppa:openjdk-r/ppa"])
    print(jdk_res1)
    jdk_res2 = subprocess.call(["sudo", "apt", "update"])
    print(jdk_res2)
    jdk_res3 = subprocess.call(["sudo", "apt", "install", "openjdk-8-jdk"])
    print(jdk_res3)
